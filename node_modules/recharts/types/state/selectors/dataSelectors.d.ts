...
export declare const selectChartDataWithIndexesIfNotInPanorama: (state: RechartsRootState, _xAxisId: AxisId, _yAxisId: AxisId, isPanorama: boolean) => ChartDataState;
