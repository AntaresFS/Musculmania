...
// Puedes poner esto en un archivo CSS global o en un archivo CSS específico para el dashboard
...
const TrainingCalendar = ({ data, loading, error }) => {
    ...
    return (
      <Card className="p-4 shadow-sm border-0 bg-white text-center">
        <Alert variant="info" className="mb-0">
          No hay días de entrenamiento registrados aún. ¡Empieza a entrenar!
        </Alert>
      </Card>
    );
  }
  ...
  const trainingDates = data.map(day => moment(day.trainingDate).toDate());
  ...
  return (
    <Card className="p-4 shadow-sm border-0 bg-white text-dark h-100">
      ...
      <Card.Body className="pt-3 d-flex justify-content-center align-items-center">
        <Calendar
